...
<table width="800" border="0" cellspacing="0" cellpadding="0">
	<form name="form1" method="get" action="${pageContext.servletContext.contextPath }/admin/member/search">
	<tr height="40">
		...
		<td width="350" align="right" valign="bottom">
			<select name="keyword-option" class="combo1">
...
<table width="800" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	...
	<tr bgcolor="#F2F2F2" height="23">
		...
		<td width="100" align="center">${vo.type == 0 ? "관리자" : "회원" }</td>
		<td width="100" align="center">
			<a href="${pageContext.servletContext.contextPath }/admin/member/modify/${vo.no}">수정</a>/
			<a href="#">삭제</a>
		</td>
	</tr>
	</c:forEach>
