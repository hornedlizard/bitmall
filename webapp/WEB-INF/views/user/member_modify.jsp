								...
								<td align="center">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												<input type="text" name='birthday1' size = "4" maxlength = "4" value = "${fn:substring(vo.birth, 0, 4) }" class="cmfont1"> <font color="898989">년</font> 
												<input type="text" name='birthday2' size = "2" maxlength = "2" value = "${fn:substring(vo.birth, 4, 6) }" class="cmfont1"> <font color="898989">월</font> 
												<input type="text" name='birthday3' size = "2" maxlength = "2" value = "${fn:substring(vo.birth, 6, 8) }" class="cmfont1"> <font color="898989">일</font> 
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name='tel1' size = "4" maxlength = "4" value = "${fn:substring(vo.tel, 0, 3) }" class="cmfont1"><font color="898989">-</font>
												<input type="text" name='tel2' size = "4" maxlength = "4" value = "${fn:length(vo.tel) == 10 ? fn:substring(vo.tel, 3, 6) : fn:substring(vo.tel, 3, 7) }" class="cmfont1"><font color="898989">-</font>
												<input type="text" name='tel3' size = "4" maxlength = "4" value = "${fn:length(vo.tel) == 10 ? fn:substring(vo.tel, 6, 10) : fn:substring(vo.tel, 6, 11) }" class="cmfont1">
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
											...
											<td>
												<input type="text" name='phone1' size = "4" maxlength = "4" value = "${fn:substring(vo.phone, 0, 3) }" class="cmfont1"><font color="898989">-</font>
												<input type="text" name='phone2' size = "4" maxlength = "4" value = "${fn:length(vo.phone) == 10 ? fn:substring(vo.phone, 3, 6) : fn:substring(vo.phone, 3, 7) }" class="cmfont1"><font color="898989">-</font>
												<input type="text" name='phone3' size = "4" maxlength = "4" value = "${fn:length(vo.phone) == 10 ? fn:substring(vo.phone, 6, 10) : fn:substring(vo.phone, 6, 11) }" class="cmfont1">
											</td>
										</tr>
										<tr>
